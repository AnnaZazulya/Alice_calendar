...
reverse_count_months = {1: 'января', 2: 'февраля', 3: 'марта', 4: 'апреля', 5: 'мая', 6: 'июня',
...
if 'сегодня' in data:
    print('https://ru.wikipedia.org/wiki/', datetime.datetime.today().day, '_',
          name_month[reverse_count_months[datetime.datetime.today().month]], sep='')
...
#print('https://ru.wikipedia.org/wiki/', datetime.datetime.today().day, '_', name_month[datetime.datetime.today().month])
#print(time.ctime())
#print(months[data[1]])
